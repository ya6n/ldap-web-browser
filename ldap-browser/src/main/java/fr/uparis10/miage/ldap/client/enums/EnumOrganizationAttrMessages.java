...
@DefaultLocale("fr")
public interface EnumOrganizationAttrMessages extends Messages {
	...
	@Key("eduOrgHomePageURI")
	String getEduOrgHomePageURI();

	@Key("eduOrgIdentityAuthNPolicyURI")
	String getEduOrgIdentityAuthNPolicyURI();

	@Key("eduOrgLegalName")
	String getEduOrgLegalName();

	@Key("eduOrgSuperiorURI")
	String getEduOrgSuperiorURI();

	@Key("eduOrgWhitePagesURI")
	String getEduOrgWhitePagesURI();
