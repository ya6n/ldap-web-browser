 ...
 * 
 */
public final class OrgUnitManagerTest {
	...
	public final void testDummySearchById() throws DataNotLoadedException {
		SearchTestUtils.testDummySearchById(OrgUnitManager.getInstance(), EnumOrgUnitAttr.ou);
	}

	@Test(timeout = 10000L)
	public final void testIndexedSearchWhiteBox() throws DataNotLoadedException {
		SearchTestUtils.testIndexedSearchWhiteBox(OrgUnitManager.getInstance(), EnumOrgUnitAttr.ou);
	}

	@Test(timeout = 10000L)
	public final void testIndexedSearchBlackBox() throws DataNotLoadedException {
		SearchTestUtils.testIndexedSearchBlackBox(OrgUnitManager.getInstance(), EnumOrgUnitAttr.ou);
	}

	@Test(timeout = 10000L)
	public final void testIndexedSearchMultiOu() throws DataNotLoadedException {
		SearchTestUtils.testIndexedSearchMulti(OrgUnitManager.getInstance(), EnumOrgUnitAttr.ou);
	}

	@Test(timeout = 10000L)
	public final void testIndexedSearchMultiSupAnn() throws DataNotLoadedException {
		SearchTestUtils.testIndexedSearchMulti(OrgUnitManager.getInstance(), EnumOrgUnitAttr.supannCodeEntite);
	}
}
